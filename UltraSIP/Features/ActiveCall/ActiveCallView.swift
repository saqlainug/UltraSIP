...
struct ActiveCallView: View {
    ...
    var body: some View {
        ...
        .padding(10)
        .background(RoundedRectangle(cornerRadius: 6).fill(BrandColor.blue.opacity(0.08)))
        .overlay(RoundedRectangle(cornerRadius: 6).stroke(BrandColor.blue.opacity(0.25)))
