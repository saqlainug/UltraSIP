...
final class MenuBarController {
    ...
    private func updateIcon() {
        ...
        if hasCall {
            symbol = "phone.fill"
            description = "MacSIP — call in progress"
            ...
            case .registered:
                symbol = "phone"
                description = "MacSIP — registered"
            case .registering:
                symbol = "phone.badge.waveform"
                description = "MacSIP — registering"
            case .failed:
                symbol = "phone.badge.checkmark"
                description = "MacSIP — registration failed"
            case .unregistered:
                symbol = "phone.down"
                description = "MacSIP — not registered"
            }
        }
    ...
    private func rebuild(_ menu: NSMenu) {
        ...
        let show = NSMenuItem(
            title: "Show MacSIP", action: #selector(MenuActions.showWindow), keyEquivalent: "")
        ...
        let quit = NSMenuItem(title: "Quit MacSIP", action: #selector(MenuActions.quit), keyEquivalent: "q")
